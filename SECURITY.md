...
- The `main` branch and the latest released tag receive security fixes.
- Older tags may receive fixes on a best-effort basis.

## Expectations

- We will investigate, prioritize, and patch confirmed issues as quickly as possible.
- We will credit reporters in release notes if they wish.
- Please avoid tests that could disrupt shared infrastructure when reproducing issues.
